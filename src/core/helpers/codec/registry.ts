...
class BinaryCodecRegistry {
    ...
    #registerBuiltinCodecs(): void {
        ...
        try {
            ...
            this.register({
                name: 'msgpack',
                encode: (obj: any) => Buffer.from(msgpack.encode(obj)),
                decode: (raw: Buffer) => msgpack.decode(raw) as any
            });
        } catch {  }
        ...
        try {
            ...
            this.register({
                name: 'cbor',
                encode: (obj: any) => cbor.encode(obj),
    ...
    public encode<T = any>(obj: T, codecName: string = 'json'): Buffer {
    ...
    public decode<T = any>(raw: Buffer, codecName: string = 'json'): T {
